...
router.post("/register", async (req, res) => {
  const { name, email, password, confirmPassword, orgName, orglogo, orgBanner, orgDescription } = req.body;
  if (!name || !email || !password || !confirmPassword || !orgName || !orglogo || !orgBanner || !orgDescription) {
